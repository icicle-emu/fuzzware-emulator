...
typedef struct {
    void* ctx;
    uc_err (*emu_start)(void*, uint64_t, uint64_t, uint64_t, uint64_t);
    uc_err (*emu_stop)(void*);
    ...
    uc_err (*mem_set)(void*, uint64_t, uint8_t, size_t);
    uc_err (*mem_protect)(void*, uint64_t, size_t, uint32_t);
    uc_err (*mem_regions)(void*, uc_mem_region**, uint32_t*);

    uc_err (*block_hook_add)(void*, uc_hook*, int, void*, void*, uint64_t, uint64_t);
    uc_err (*mem_hook_add)(void*, uc_hook*, int, void*, void*, uint64_t, uint64_t);
    uc_err (*int_hook_add)(void*, uc_hook*, int, void*, void*, uint64_t, uint64_t);
    uc_err (*hook_del)(void*, uc_hook);

    uc_err (*context_alloc)(void*, uc_context**);
    uc_err (*context_save)(void*, uc_context*);
    uc_err (*context_restore)(void*, uc_context*);
    uc_err (*free)(void*);
    uc_err (*fuzzer_init_cov)(void*, void*, uint32_t);
    uc_err (*fuzzer_reset_cov)(void*, int);

    uc_err (*save_info)(void*);
